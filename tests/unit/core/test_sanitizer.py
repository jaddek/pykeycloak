...
class TestSensitiveDataSanitizer:
    ...
    def test_sanitize_nested_dict_with_sensitive_data(self):
        ...
        data = {
            "user": {
                "username": "john_doe",
                "password": "secret123",
                "profile": {"email": "john@example.com", "access_token": "abc123xyz"},
            },
        ...
        expected = {
            "user": {
                "username": "john_doe",
                "password": "<hidden>",
                "profile": {"email": "john@example.com", "access_token": "<hidden>"},
            },
    ...
    def test_sanitize_list_containing_sensitive_data(self):
        ...
        data = [
            ...
            {"username": "jane_doe", "access_token": "token123"},
        ]

        expected = [
            {"username": "john_doe", "password": "<hidden>"},
            {"username": "jane_doe", "access_token": "<hidden>"},
        ]
        ...
        data = {
            "users": [
                ...
                },
                {
                    "id": 2,
                    "username": "jane_doe",
                    "credentials": {"password": "another_secret", "id_token": "id456"},
                },
            ],
            "config": {"client_secret": "very_secret", "public_setting": "not_secret"},
        }
        ...
        expected = {
            "users": [
                ...
                },
                {
                    "id": 2,
                    "username": "jane_doe",
                    "credentials": {"password": "<hidden>", "id_token": "<hidden>"},
                },
            ],
            "config": {"client_secret": "<hidden>", "public_setting": "not_secret"},
        }
    ...
    def test_sanitize_deeply_nested_structure(self):
        ...
        data = {
            "level1": {
                "level2": {
                    "level3": {"level4": {"password": "deep_secret", "normal": "value"}}
                }
            }
        }
        ...
        expected = {
            "level1": {
                "level2": {
                    "level3": {"level4": {"password": "<hidden>", "normal": "value"}}
                }
            }
        }
